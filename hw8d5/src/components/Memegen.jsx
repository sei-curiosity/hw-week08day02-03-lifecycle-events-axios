...
class Memegen extends Component {
    ...
    handleSubmit = event => {
        event.preventDefault() // make it the page not refresh 
    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                <div className="meme">
                    <img
                    src={this.state.randomImg} alt="" width="200" height="200"/>
                    <h2 className="top">{this.state.title}</h2>
                    <h2 className="bottom">{this.state.image}</h2>
                </div>
           </div>
        )
    }
